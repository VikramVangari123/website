...
// Our work videos section
    ...
    // Get the modal
    var modal = document.getElementById('ow-modal');
    // Get the video that opens the modal
    var ow_videos_in = document.getElementById("ow_videos_in");
    var ow_video1Src = document.getElementById("ow_video1Src");
    var ow_video2Src = document.getElementById("ow_video2Src");
    var ow_video3Src = document.getElementById("ow_video3Src");
    var ow_video4Src = document.getElementById("ow_video4Src");
    //var ow_videoSrc  = document.getElementsByClassName("ow_videoSrc");

    // modal videos
    var ow_video1Mdl = document.getElementById("ow_video1Mdl");
    var ow_video2Mdl = document.getElementById("ow_video2Mdl");
    var ow_video3Mdl = document.getElementById("ow_video3Mdl");
    var ow_video4Mdl = document.getElementById("ow_video4Mdl");
    var ow_videoMdl = document.getElementsByClassName("ow_videoMdl");

    // Get the <span> element that closes the modal
    var span = document.getElementsByClassName("close")[0];

    // When the user clicks on the button, open the modal 
    ow_videos_in.onclick = function() {
        modal.style.display = "block";
        ow_videoMdl.get(0).play();  
    }
    ow_video1Src.onclick = function() {
        ow_video1Mdl.style.display = "block";
        ow_video1Mdl.play();  
    }
    ow_video2Src.onclick = function() {
        ow_video2Mdl.style.display = "block";
        ow_video2Mdl.play();  
    }
    ow_video3Src.onclick = function() {
        ow_video3Mdl.style.display = "block";
        ow_video3Mdl.play();  
    }
    ow_video4Src.onclick = function() {
        ow_video4Mdl.style.display = "block";
        ow_video4Mdl.play();  
    }
    ...
    span.onclick = function() {
        ...
        ow_video1Mdl.style.display = "none";
        ow_video2Mdl.style.display = "none";
        ow_video3Mdl.style.display = "none";
        ow_video4Mdl.style.display = "none";  
    }
    ...
    $('.close').click(function(event){
        $('.ow_videoMdl').each(function(){ 
            this.currentTime = 0;
            this.pause();
        });
        $('.ow_videoMdl').get(0).pause();
    ...
    $('#ow_videos_in').click(function(event){
